                    ...
                    else
                    {
                        ...
                        if (first is MalSymbol)
                        {
                            ...
                            if (firstSymbol.value == "defmacro!")
                            {
                                ...
                                {
                                    macroValue = new MalFunction( ((MalFunction)value).function );
                                    ((MalFunction)macroValue).is_macro = true;
                                }
                                else
                                {
                                    macroValue = new MalFnTco(value, new List<MalSymbol>(), env, ((MalFnTco)value).fn);
                                    ((MalFnTco)macroValue).is_macro = true;
                                }
                                env.set(symbol, macroValue);
                                return value;
                            }
