...
for k, v in core.ns.items(): repl_env.set(types._symbol(k), types.Function(v))
repl_env.set(types._symbol('eval'), types.Function(lambda ast: EVAL(ast, repl_env)))
