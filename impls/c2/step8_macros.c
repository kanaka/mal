...
MalType* quasiquote(MalType* ast) {
  ...
  /* argument to quasiquote is not a list or vector: (quasiquote val)
     => (quote val) */
  if (!is_sequential(ast)) {
  ...
  /* argument to quasiquote is a list or vector: (quasiquote (first rest)) */
  else {
